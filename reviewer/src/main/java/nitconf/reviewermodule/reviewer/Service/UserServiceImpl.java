...
import nitconf.reviewermodule.reviewer.Entity.Role;
...
public class UserServiceImpl implements UserService{
	...
	public User save(UserRegistrationDto registrationDto) {
		User user = new User(registrationDto.getFirstName(), 
				...
				passwordEncoder.encode(registrationDto.getPassword()), registrationDto.getPhoneNo(), registrationDto.getEducationLevel(), Arrays.asList(new Role("ROLE_USER")));
