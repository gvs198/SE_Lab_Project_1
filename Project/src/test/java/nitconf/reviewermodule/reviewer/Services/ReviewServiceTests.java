...
public class ReviewServiceTests {
    ...
    void createReviewForPaper_PaperNotFound_ReturnsFalse() {
        ...
        boolean result = reviewService.createReviewForPaper("Review Body", 1, 1, "user123");
        assertFalse(result);
    }
    ...
    void updateReviewForPaper_PaperNotFound_ReturnsFalse() {
        when(paperRepository.findByPaperid(anyInt())).thenReturn(null);
        boolean result = reviewService.updateReviewForPaper("Updated Review Body", 1, 1, "user123");
        assertFalse(result);
    }
    ...
    void deleteReviewForPaper_Success_ReturnsTrue() {
        ...
        verify(reviewedPapersRepository).delete(any());
    }
